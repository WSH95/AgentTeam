...
- [ ] G5 — deterministic acceptance/fault matrix plus full V1 and cross-platform regression (**local audit green; hosted attempt 32905220326 was 10/12 green and exposed unsafe Windows `os.kill(pid, 0)` liveness probing; `OpenProcess` fix is locally green at 35 focused and 737 full-suite tests + 4 expected skips; replacement hosted run pending**)
