...
| Final hosted candidate | **PASS, 12/12** — run [32908268851](https://github.com/WSH95/AgentTeam/actions/runs/32908268851) completed successfully at exact product SHA `35790ad9271ff26332c91ae435858f6115303d53`: six scaffold legs across Ubuntu/macOS/Windows and Python 3.11/3.13, three optional ClawTeam jobs, and three credential-free vendor-smoke jobs all passed. Both Windows scaffold legs passed the full suite and named M1c acceptance |
| Gate | **G6 closed** with Grok supported and Claude/Codex excluded (ADR 0047). Grok's pass activates the plan's conditional 23-call hard ceiling, but only its five lifecycle calls are eligible now. The exact candidate is locally and hosted green; G7 remains stopped on a fresh attended owner go |
