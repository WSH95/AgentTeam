...
| Boundary | PASS — deterministic fakes only; no vendor executable, model/live call, credential read, dependency/schema/optional-provider/vendor-smoke/AGENTS/CLAUDE/M1c change, or push; pre-existing `.codex/` untouched |
