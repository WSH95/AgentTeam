...
status: draft v2.1 — current versions and owner-authorized ATM reuse applied
date: 2026-08-22
...
| ATM | `agent-team-manager-dev@12a727e` (0.0.0, private) | no public licence; **owner-authorized internal ATS reuse** | copy/adapt allowed inside this project; preserve source provenance and third-party notices; no public relicensing implied | [ev:m0-product-architecture-review-2026-08-22#F7] |
...
2. ATM internal reuse is resolved by owner authorization. A future public licence for ATS/ATM remains a separate release decision [ev:m0-product-architecture-review-2026-08-22#F7].
